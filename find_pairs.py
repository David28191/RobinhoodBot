...
UNIVERSE = {
    "staples":    ["KO", "PEP", "PG", "CL", "MDLZ", "KMB", "GIS"],
    "payments":   ["V", "MA", "AXP", "PYPL", "FI", "GPN"],
    "energy":     ["XOM", "CVX", "COP", "EOG", "OXY", "PSX", "MPC", "VLO"],
    "oilservices":["SLB", "HAL", "BKR"],
    "retail":     ["HD", "LOW", "TGT", "WMT", "COST", "DG", "DLTR"],
    "pharma":     ["MRK", "PFE", "LLY", "ABBV", "BMY", "JNJ"],
    "biotech":    ["AMGN", "GILD", "VRTX", "REGN", "BIIB"],
    "payers":     ["UNH", "ELV", "CI", "HUM", "CVS"],
    "medtech":    ["MDT", "SYK", "BSX", "ABT", "ISRG"],
    "bigtech":    ["AAPL", "MSFT", "GOOGL", "META", "AMZN"],
    "software":   ["CRM", "ORCL", "ADBE", "NOW", "SAP", "INTU"],
    "semis":      ["NVDA", "AMD", "INTC", "AVGO", "TSM", "QCOM", "TXN", "MU"],
    "banks":      ["JPM", "BAC", "WFC", "C", "GS", "MS", "USB", "PNC", "TFC"],
    "assetmgrs":  ["BLK", "BX", "KKR", "TROW", "BEN", "APO"],
    "insurance":  ["MET", "PRU", "AIG", "ALL", "TRV", "CB", "PGR"],
    "industrials":["CAT", "DE", "HON", "MMM", "EMR", "GE", "ETN"],
    "defense":    ["LMT", "RTX", "NOC", "GD", "BA", "LHX"],
    "transports": ["UPS", "FDX", "UNP", "CSX", "NSC"],
    "airlines":   ["DAL", "UAL", "AAL", "LUV"],
    "autos":      ["GM", "F", "STLA"],
    "telecom":    ["T", "VZ", "TMUS"],
    "media":      ["DIS", "NFLX", "WBD", "PARA", "CMCSA"],
    "restaurants":["MCD", "YUM", "CMG", "SBUX", "DRI"],
    "homebuild":  ["DHI", "LEN", "PHM", "NVR", "TOL"],
    "utilities":  ["DUK", "SO", "NEE", "AEP", "D", "EXC"],
    "reits":      ["AMT", "PLD", "SPG", "O", "PSA", "EQIX"],
    "miners":     ["NEM", "GOLD", "FCX", "SCCO"],
